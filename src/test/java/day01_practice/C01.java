...
public class C01 {
    ...
    public void test01() {
        ...
        // genisligi 225 ve uzunlugu 225 olan resimlerin hepsine sırasıyla tıklayınız ve sayfa baslıgını yazdırınız
       List<WebElement> image= driver.findElements(By.xpath("//img[@width='225' and @height='225']"));//*[@width='225'] | //*[@height='225']
        for (int i = 0; i < image.size() ; i++) {
            image= driver.findElements(By.xpath("//img[@width='225' and @height='225']"));
            image.get(i).click();
